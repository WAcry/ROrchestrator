...
{
    private const string FlowLatencyInstrumentName = "rockestra.flow.latency.ms";
    private const string FlowOutcomeInstrumentName = "rockestra.flow.outcomes";
    private const string StepLatencyInstrumentName = "rockestra.step.latency.ms";
    private const string StepOutcomeInstrumentName = "rockestra.step.outcomes";
    private const string StepSkipReasonInstrumentName = "rockestra.step.skipped.reasons";
    private const string JoinLatencyInstrumentName = "rockestra.join.latency.ms";
    private const string JoinOutcomeInstrumentName = "rockestra.join.outcomes";
