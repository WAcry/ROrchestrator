...
{
    private const string StageFanoutModuleLatencyInstrumentName = "rorchestrator.stage.fanout.module.latency.ms";
    private const string StageFanoutModuleOutcomeInstrumentName = "rorchestrator.stage.fanout.module.outcomes";
    ...
    {
        var patchJson =
            "{\"schemaVersion\":\"v1\",\"flows\":{\"MetricsTestFlow.Fanout\":{" +
